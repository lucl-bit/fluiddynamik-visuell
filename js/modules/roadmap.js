  ...
  build: function (root) {
    ...
    var ITEMS = [
      ...
      { k: 'Bereits gebaut', p: 'A', done: true, link: 'wirbel',
        t: 'Die vier Modellwirbel',
        d: 'Starrkörper und Potentialwirbel: Bahn identisch, Eigendrehung völlig verschieden. Dazu der Rankine-Wirbel mit verschiebbarem Kernradius, Druckdelle und Trichter, die Zirkulation aller drei und der Hillsche Kugelwirbel als räumliches Gegenstück — im Meridianschnitt, umschaltbar zwischen Laborsystem und mitbewegtem System.',
        m: 'Kap. 10.1, S. 79–81' },
      { k: 'Bereits gebaut', p: 'A', done: true, link: 'wirbellinien',
        t: 'Wirbellinien und die ebene Grenzschicht',
        d: 'Wo Wirbellinien in fünf Standardströmungen wirklich liegen, die Blasius-Grenzschicht mit ω-Verteilung und mitschwimmenden Schaufelrädern, die ausgelenkte Wirbellinie (Λ-Wirbel), Galilei-Invarianz und Helmholtz.',
        m: 'Kap. 10.1, S. 82 f., Tab. 10.1, Abb. 10.4' },
      { k: 'Bereits gebaut', p: 'A', done: true, link: 'biotsavart',
        t: 'Biot-Savart — woher die Geschwindigkeit kommt',
        d: 'Das Linienintegral Beitrag für Beitrag am drehbaren 3D-Modell, die Winkelformel Γ/(4πr)(cos θ₁ − cos θ₂) mit numerischer Gegenprobe, die Grenzübergänge zum Potentialwirbel und zum halbunendlichen Faden, dazu ein Rechenlabor mit drei Prüfungsgeometrien (Gleitschirm, Tragflügel, zwei koaxiale Ringe).',
        m: 'Kap. 10.1, S. 83 f., Abb. 10.5' },
      ...
      { k: 'Bereits gebaut', p: 'A', done: true, link: 'tragfluegel',
        t: 'Tragflügel: 2D gegen 3D',
        d: 'Warum die ebene Theorie keinen Widerstand kennt und der endliche Flügel zwingend einen hat. Mit integrierten Stromlinien um den Flügel, Hufeisenmodell, Traglinie in Glauert-Form (elliptisch als beweisbares Optimum), Kräftezerlegung am Profilschnitt und c_W,ind = c_A²/(πΛ).',
        m: 'Kap. 10.4, S. 89–91, Abb. 10.7–10.9' },
      ...
      { k: 'Bereits gebaut', p: 'A', done: true, link: 'kanal',
        t: 'Kanallabor: Fläche, Reibung, Sperrung',
        d: 'Ein Kanal, umschaltbar zwischen Laval und Fanno. Zeigt, wo Ma = 1 auftritt (Hals gegen Rohrende), wann gesperrt wird und warum der Massenstrom danach nicht mehr auf den Gegendruck reagiert.',
        m: 'Kap. 11.4 und 11.7, S. 105–108 / 117–119' },
      { k: 'Bereits gebaut', p: 'A', done: true, link: 'freistrahl',
        t: 'Freistrahl: die Wellen lesen',
        d: 'Was eine einzelne Linie im Rautenmuster ist, Schritt-für-Schritt-Konstruktion ihres Wegs, die zwei Reflexionsregeln (Achse gleichartig, freier Rand kippt) und der Druckverlauf auf der Achse.',
        m: 'Kap. 11.5–11.6, S. 109–115' },
      ...
      { k: 'Kap. 7 · Grenzschichten', p: 'B',
        t: 'Grenzschicht mit Druckgradient (Falkner-Skan)',
        d: 'Die Blasius-Lösung mit δ(x) ~ √(νx/u∞) und der Ähnlichkeitsvariablen η läuft bereits im Kapitel <a href="#wirbellinien">Wirbellinien</a>. Offen ist der Keilwinkel-Parameter: beschleunigte Aussenströmung macht das Profil völliger, verzögerte treibt es zur Ablösung.',
        m: 'Kap. 7.2, S. 42' },
      ...
      { k: 'Kap. 10 · Drehungsbehaftete Strömungen', p: 'A',
        ...
        m: 'Kap. 10.2, S. 85 f.' },
      { k: 'Kap. 10 · Drehungsbehaftete Strömungen', p: 'C',
        t: 'Wirbelröhre als bewegter Körper',
        d: 'Die Aussagen von Helmholtz und Kelvin stehen bereits im Kapitel <a href="#wirbellinien">Wirbellinien</a>. Offen ist nur noch die Animation der Röhre selbst: wie sie sich verformt, dünner wird und dabei ihre Zirkulation behält.',
        m: 'Kap. 10.3, S. 87 ff.' },
      { k: 'Kap. 10 · Drehungsbehaftete Strömungen', p: 'C',
        t: 'Leapfrogging zweier Wirbelringe, voll animiert',
        d: 'Die induzierten Geschwindigkeiten beider Ringe stehen bereits im Kapitel <a href="#biotsavart">Biot-Savart</a>. Offen ist nur noch die Zeitintegration: wie der hintere Ring sich verengt, durch den vorderen schlüpft, sich weitet und die Rollen tauscht.',
        m: 'Kap. 10.3, S. 83' },

      /* ---- Kap. 11 Kompressibel ---- */
      { k: 'Kap. 11 · Kompressible Strömungen', p: 'B',
        t: 'Prandtl-Meyer an der einzelnen Ecke',
        d: 'ν(Ma) und die Reflexionsregeln laufen bereits im Kapitel <a href="#freistrahl">Freistrahl</a>. Offen ist der Fächer an der konvexen Ecke selbst: wie sich die Stromlinie darin stetig krümmt.',
        m: 'Kap. 11.6, S. 112 ff.' },
      { k: 'Kap. 11 · Kompressible Strömungen', p: 'B',
        t: 'Energie-Ellipse',
      ...
      { k: 'Kap. 11 · Kompressible Strömungen', p: 'C',
        t: 'Die Flächen-Geschwindigkeits-Beziehung als Formel',
        d: 'Sperrung und A/A* stecken im <a href="#kanal">Kanallabor</a>. Offen ist nur noch die Herleitung selbst: der Vorzeichenwechsel von (Ma²−1) in dA/A = (Ma²−1)·du/u.',
        m: 'Kap. 11.4, S. 105 ff.' },
      { k: 'Kap. 11 · Kompressible Strömungen', p: 'B',
      ...
      { k: 'Kap. 11 · Kompressible Strömungen', p: 'C',
        t: 'Fanno-Kurve im Mollier-Diagramm',
        d: 'Die Fanno-Strömung selbst läuft im <a href="#kanal">Kanallabor</a>. Offen ist die Darstellung im h-s-Diagramm (Abb. 11.17) mit den zwei Ästen und dem Entropiemaximum bei Ma = 1.',
        m: 'Kap. 11.7, Abb. 11.17' },
